...
with open(OUTPUT_FILE, "w", encoding="utf-8") as file:
    ...
    file.write("vless://00000000-0000-0000-0000-000000000000@0.0.0.0:2?security=&encryption=none&headerType=&type=tcp##GitHub:%20github.com/abtin-rz/telegram-scraper\n")
